...
export const emailRegistro = async (data) => {
  ...
  <div style="text-align: center; margin: 20px 0 30px;"><span style="font-weight: bold; color: #0284c7; font-size: 30px; margin-left: 10px;">Bienes Raices</span></div>
  <p style="color: #757575; font-family: 'Open Sans', Roboto, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; letter-spacing: normal;">Hola ${nombre} comprueba tu cuenta en Bienes Raices,</p>
  ...
  <p><a style="background: #0284c7; color: white; font-weight: 500; display: inline-block; padding: 10px 35px; margin: 6px 8px; text-decoration: none; border-radius: 2px;" href="${process.env.FRONTEND_URL}/auth/confirmar/${token}" target="_blank" rel="noopener">Confirmar</a></p>
  ...
  <p style="font-style: italic; margin-bottom: 0;">Copyright &copy; ${new Date().getFullYear()} Bienes Raices, All rights reserved.</p>
  ...
  const msg = {
    ...
    subject: 'Compruebe su cuenta en Bienes Raices',
    text: 'Bienes Raices',
    html: HTML_CONFIRMAR
  }
  sgMail
...
export const emailOlvidePassword = async (data) => {
  ...
  const HTML_RESTABLECER = `
  <div style="font-family: 'Open Sans','Roboto','Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; color: #757575; line-height: 150%; letter-spacing: normal;">
  <div style="background: #0284c7; padding: 50px 10px;">
  <div style="max-width: 600px; margin: auto;">
  <div style="background: white; padding: 15px 30px 25px 30px; border-radius: 5px;">
  <div style="text-align: center; margin: 20px 0 30px;"><span style="font-weight: bold; color: #0284c7; font-size: 30px; margin-left: 10px;">Restablecer password en Bienes Raices</span></div>
  ...
  <p style="color: #757575; font-family: 'Open Sans', Roboto, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; letter-spacing: normal;"><a style="background: #0284c7; color: white; font-weight: 500; display: inline-block; padding: 10px 35px; margin: 6px 8px; text-decoration: none; border-radius: 2px;" href="${process.env.FRONTEND_URL}/auth/nuevo-password/${token}" target="_blank" rel="noopener">Restablecer password</a></p>
  <p style="color: #757575; font-family: 'Open Sans', Roboto, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; letter-spacing: normal;">En enlace expira inmediatamente cuando se abre.</p>
...
`
  ...
  const msg = {
    to: email,
    from: 'martinflorestorres21@gmail.com',
    subject: 'Restablecer password - Bienes Raices.',
    text: 'Bienes Raices',
    html: HTML_RESTABLECER
  }
  sgMail
    .send(msg)
    .then(() => {
